...
function Partners() {
  ...
  return (
    <div className="overflow-hidden py-20 bg-[#F8F5F2] md:py-[100px]">
      <h3 className="font-montreal font-normal text-center text-xl md:text-2xl">
        Our valued partners
      </h3>
      <div className="logos flex items-end w-[2000px] gap-[90px] pt-10 md:pt-24 md:gap-36 xl:gap-[250px]">
        <img src={deyaar} alt="image" className="object-center object-contain " />
        <img src={danube} alt="image" className="object-center object-contain" />
        <img src={meydan} alt="image" className="object-center object-contain" />
        <img src={meras} alt="image" className="object-center object-contain" />
        <img src={damac} alt="image" className="object-center object-contain" />
        <img src={emaar} alt="image" className="object-center object-contain" />
        <img src={nakheel} alt="image" className="object-center object-contain" />
        <img src={sobha} alt="image" className="object-center object-contain" />
      </div>

      <div className="container pt-20">
        <div className="top md:flex md:justify-between items-end md:items-start">
          <div className="title ">
            ...
            <h1 className="font-montreal font-normal text-4xl pt-[25px] md:text-[56px] leading-10 md:leading-[68px]">
              Frequent Asked <br />
              Questions
            </h1>
          ...
          <div className="card py-[30px] px-5 bg-white rounded-2xl w-full md:w-1/2 md:py-[50px] md:px-[30px]">
            <div className="flex justify-between items-center border-y-[1px] border-[#00000033] py-4 gap-11 md:gap-[18px]">
            ...
            <div className="flex justify-between items-center border-b-[1px] border-[#00000033] py-4 gap-11 md:gap-[18px]">
              <h6 className="font-montreal font-normal text-base  w-[85%] md:text-xl">
